...
if (!todos) {
  // load sample todos
  todos = [
    {id: 1, title: 'SampleToDo', description: 'something todo', dueDate:'', importance:3, finished: false, guid:"6290969e-e73d-487d-8eb4-acb490e0a5fe"},
    {id: 2, title: 'SampleElseToDo', description: 'something else todo', dueDate:'', importance:1,finished: false, guid:"c3491f73-3f4d-4dd8-a45b-79cbcc77d623"},
    {id: 3, title: 'Dont forget', description: 'i forgot', dueDate:'', importance:4,finished: true, guid: "50736f1d-5566-49ad-9f02-61608982a671"},
    {id: 4, title: 'A thing i need to do', description: 'something todo123', dueDate:'', importance:4,finished: false, guid:"286f4fb8-1ef3-429a-952d-baa47b894d47"}
  ];
